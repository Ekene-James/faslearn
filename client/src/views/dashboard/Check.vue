							...
							<div class="ttl121">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="membership.html">Paid Membership</a></li>
											...
											<div class="media__body">
												<ul id="paypal-gateway" class="financial-institutes">
													<li class="financial-institutes__logo">
														<img alt="Visa" title="Visa" src="assets/images/membership/pyicon-1.svg">
													</li>
													<li class="financial-institutes__logo">
														<img alt="MasterCard" title="MasterCard" src="assets/images/membership/pyicon-2.svg">
													</li>
													<li class="financial-institutes__logo">
														<img alt="American Express" title="American Express" src="assets/images/membership/pyicon-3.svg">
													</li>
													<li class="financial-institutes__logo">
														<img alt="Discover" title="Discover" src="assets/images/membership/pyicon-4.svg">
													</li>
													<li class="financial-institutes__logo">
														<img alt="China UnionPay" title="China UnionPay" src="assets/images/membership/pyicon-5.svg">
													</li>
												</ul>
											</div>
										</div>
