...
export default {
    mounted(){
        ...
        jsm.setAttribute('src', 'js/main.js')
        document.head.appendChild(js)
        let jsc = document.createElement('script')
        jsc.setAttribute('src', 'js/common_scripts.js')
        document.head.appendChild(jsc)
        let jsa = document.createElement('script')
        jsa.setAttribute('src', 'assets/validate.js')
        document.head.appendChild(jsa)

        let js = document.createElement('script')
        js.setAttribute('src', 'js/admission_func.js')
        document.head.appendChild(js)
        let jsw = document.createElement('script')
        jsw.setAttribute('src', 'js/jquery.wizard.js')
        document.head.appendChild(jsw)
        let jsv = document.createElement('script')
        jsv.setAttribute('src', 'js/jquery.validate.js')
        document.head.appendChild(jsv)
